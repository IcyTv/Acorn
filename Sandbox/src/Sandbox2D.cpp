...
void Sandbox2D::OnImGuiRender(Acorn::Timestep t)
{
	...
	ImGui::Text("Quad Count %d", Acorn::ext2d::Renderer::GetQuadCount());
	ImGui::Text("Draw Calls %d", Acorn::ext2d::Renderer::GetDrawCalls());
	ImGui::Text("Vertices %d", Acorn::ext2d::Renderer::GetVertexCount());
	ImGui::Text("Indices %d", Acorn::ext2d::Renderer::GetIndexCount());
