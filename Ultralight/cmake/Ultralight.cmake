# Adapted from https://github.com/ultralight-ux/ultralight-quick-start
...
MACRO(ADD_ULTRALIGHT target)
	set(APP_NAME ${target})

	message(STATUS "Adding Ultralight target '${APP_NAME}' ${ULTRALIGHT_INCLUDE_DIR}")

	target_include_directories(${APP_NAME} PUBLIC "${ULTRALIGHT_INCLUDE_DIR}")
	target_link_directories(${APP_NAME} PUBLIC "${ULTRALIGHT_LIBRARY_DIR}")
	target_link_libraries(${APP_NAME} UltralightCore AppCore Ultralight WebCore)
	...
	if(${ENABLE_INSPECTOR})
		message(STATUS "Enabling inspector")
